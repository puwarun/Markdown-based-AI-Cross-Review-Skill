...
```text
ใช้ $mag กับไฟล์ Markdown analysis ที่แนบมา

Context:
<อธิบายสั้น ๆ ว่าไฟล์เหล่านี้เกี่ยวกับอะไร>

Goal:
สร้าง graph-first review จากผลวิเคราะห์เหล่านี้
...
```text
ใช้ $mag วิเคราะห์ codex_analyst.md และ gemini_analyst.md

Context:
ทั้งสองไฟล์เป็นผลวิเคราะห์ด้าน performance ของ encryption library

Goal:
สร้าง graph ที่แสดงว่า:
- claim ไหนตรงกัน
- recommendation ไหนขัดแย้งกัน
- risk ไหนเป็นตัว qualify recommendation
- อะไรควรทำตอนนี้ ทำทีหลัง ทำแบบมีเงื่อนไข หรือควรหลีกเลี่ยง
...
```text
ใช้ $mag วิเคราะห์ไฟล์ .md ที่แนบมา
...
หลังจากอัปเดตไฟล์ของทั้งสองฝ่ายแล้ว ใช้ $mag เพื่อสร้าง:
